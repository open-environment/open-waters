...
alter table T_OE_USERS ALTER COLUMN USER_ID varchar(200);

alter table T_OE_USERS ALTER COLUMN CREATE_USERID varchar(200);
alter table T_OE_USERS ALTER COLUMN MODIFY_USERID varchar(200);
alter table T_OE_APP_SETTINGS ALTER COLUMN MODIFY_USERID varchar(200);
alter table T_OE_APP_TASKS ALTER COLUMN MODIFY_USERID varchar(200);
alter table T_OE_ROLES ALTER COLUMN CREATE_USERID varchar(200);
alter table T_OE_ROLES ALTER COLUMN MODIFY_USERID varchar(200);
alter table T_OE_USER_ROLES ALTER COLUMN CREATE_USERID varchar(200);
alter table T_WQX_ACTIVITY ALTER COLUMN CREATE_USERID varchar(200);
alter table T_WQX_ACTIVITY ALTER COLUMN UPDATE_USERID varchar(200);
alter table T_WQX_ACTIVITY_METRIC ALTER COLUMN CREATE_USERID varchar(200);
alter table T_WQX_ACTIVITY_METRIC ALTER COLUMN UPDATE_USERID varchar(200);
alter table [dbo].[T_WQX_BIO_HABITAT_INDEX] ALTER COLUMN CREATE_USERID varchar(200);
alter table [dbo].[T_WQX_BIO_HABITAT_INDEX] ALTER COLUMN UPDATE_USERID varchar(200);
alter table [dbo].[T_WQX_IMPORT_LOG] ALTER COLUMN CREATE_USERID varchar(200);

alter table [dbo].[T_WQX_IMPORT_TEMP_ACTIVITY_METRIC] ALTER COLUMN USER_ID varchar(200);
alter table [dbo].[T_WQX_IMPORT_TEMP_BIO_INDEX] ALTER COLUMN USER_ID varchar(200);
alter table [dbo].[T_WQX_IMPORT_TEMP_MONLOC] ALTER COLUMN USER_ID varchar(200);
alter table [dbo].[T_WQX_IMPORT_TEMP_PROJECT] ALTER COLUMN USER_ID varchar(200);
alter table [dbo].[T_WQX_IMPORT_TEMP_SAMPLE] ALTER COLUMN USER_ID varchar(200);

alter table [dbo].[T_WQX_IMPORT_TEMPLATE] ALTER COLUMN CREATE_USERID varchar(200);
alter table [dbo].[T_WQX_IMPORT_TEMPLATE_DTL] ALTER COLUMN CREATE_USERID varchar(200);
alter table [dbo].[T_WQX_IMPORT_TRANSLATE] ALTER COLUMN CREATE_USERID varchar(200);
alter table T_WQX_MONLOC ALTER COLUMN CREATE_USERID varchar(200);
alter table T_WQX_MONLOC ALTER COLUMN UPDATE_USERID varchar(200);

alter table T_WQX_ORG_ADDRESS ALTER COLUMN CREATE_USERID varchar(200);
alter table T_WQX_ORG_ADDRESS ALTER COLUMN UPDATE_USERID varchar(200);
alter table T_WQX_ORGANIZATION ALTER COLUMN CREATE_USERID varchar(200);
alter table T_WQX_ORGANIZATION ALTER COLUMN UPDATE_USERID varchar(200);
alter table T_WQX_PROJECT ALTER COLUMN CREATE_USERID varchar(200);
alter table T_WQX_PROJECT ALTER COLUMN UPDATE_USERID varchar(200);
alter table [dbo].[T_WQX_REF_CHAR_LIMITS] ALTER COLUMN CREATE_USERID varchar(200);
alter table [dbo].[T_WQX_REF_CHAR_LIMITS] ALTER COLUMN UPDATE_USERID varchar(200);
alter table [dbo].[T_WQX_REF_CHAR_ORG] ALTER COLUMN CREATE_USERID varchar(200);
alter table [dbo].[T_WQX_REF_LAB] ALTER COLUMN CREATE_USERID varchar(200);
alter table [dbo].[T_WQX_REF_LAB] ALTER COLUMN UPDATE_USERID varchar(200);
alter table [dbo].[T_WQX_REF_TAXA_ORG] ALTER COLUMN CREATE_USERID varchar(200);
alter table [dbo].[T_WQX_USER_ORGS] ALTER COLUMN CREATE_USERID varchar(200);
