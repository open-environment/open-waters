...
INSERT INTO [dbo].[T_OE_APP_SETTINGS] ([SETTING_NAME],[SETTING_VALUE],[MODIFY_USERID],[MODIFY_DT]) VALUES ('CDX Submission URL','https://testngn.epacdxnode.net/ngn-enws20/services/NetworkNode2ServiceConditionalMTOM','SYSTEM',GetDate());
INSERT INTO [dbo].[T_OE_APP_SETTINGS] ([SETTING_NAME],[SETTING_VALUE],[MODIFY_USERID],[MODIFY_DT]) VALUES ('CDX Ref Data URL','http://cdx.epa.gov/WQXWeb/services.asmx','SYSTEM',GetDate());
INSERT INTO [dbo].[T_OE_APP_SETTINGS] ([SETTING_NAME],[SETTING_VALUE],[MODIFY_USERID],[MODIFY_DT]) VALUES ('CDX Submitter','','SYSTEM',GetDate());
INSERT INTO [dbo].[T_OE_APP_SETTINGS] ([SETTING_NAME],[SETTING_VALUE],[ENCRYPT_IND],[SETTING_VALUE_SALT],[MODIFY_USERID],[MODIFY_DT]) VALUES ('CDX Submitter Password','',1,'','SYSTEM',GetDate());
INSERT INTO [dbo].[T_OE_APP_SETTINGS] ([SETTING_NAME],[SETTING_VALUE],[MODIFY_USERID],[MODIFY_DT]) VALUES ('Default Timezone','','SYSTEM',GetDate());
INSERT INTO [dbo].[T_OE_APP_SETTINGS] ([SETTING_NAME],[SETTING_VALUE],[MODIFY_USERID],[MODIFY_DT]) VALUES ('Log Level','ERROR','SYSTEM',GetDate());
INSERT INTO [dbo].[T_OE_APP_SETTINGS] ([SETTING_NAME],[SETTING_VALUE],[MODIFY_USERID],[MODIFY_DT]) VALUES ('EMAIL FROM','OpenWaters@open-environment.org','SYSTEM',GetDate());
INSERT INTO [dbo].[T_OE_APP_SETTINGS] ([SETTING_NAME],[SETTING_VALUE],[MODIFY_USERID],[MODIFY_DT]) VALUES ('EMAIL SERVER','localhost','SYSTEM',GetDate());
...
INSERT INTO [dbo].[T_OE_APP_SETTINGS] ([SETTING_NAME],[SETTING_VALUE],[MODIFY_USERID],[MODIFY_DT]) VALUES ('Default State','OK','SYSTEM',GetDate());
