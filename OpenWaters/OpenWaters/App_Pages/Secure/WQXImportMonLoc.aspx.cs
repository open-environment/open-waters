...
namespace OpenEnvironment
{
    public partial class WQXImportMonLoc : System.Web.UI.Page
    {
        ...
        protected void btnImport_Click(object sender, EventArgs e)
        {
                ...
                if (check.Checked)
                {
                    ...
                    if (m != null)
                    {
                        ...
                        int SuccID = db_WQX.InsertOrUpdateWQX_MONLOC(m.MONLOC_IDX, m.ORG_ID, m.MONLOC_ID, m.MONLOC_NAME, m.MONLOC_TYPE, m.MONLOC_DESC, m.HUC_EIGHT, m.HUC_TWELVE, m.TRIBAL_LAND_IND,
                            ...
                            m.WELLHOLE_DEPTH_MSR_UNIT, "U", null, true, chkWQXImport.Checked, User.Identity.Name);
            ...
            //add to import log
            db_Ref.InsertUpdateWQX_IMPORT_LOG(null, OrgID, "MonitoringLocations", "MonitoringLocations", 0, "Success", null, User.Identity.Name);
